        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{route('site.index')}}" target="_blank">
                        <?php
                ...
                <ul class="nav navbar-nav mr-auto float-left">
                    {{--<li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="ficon ft-search"></i></a>
                        <div class="search-input">
                            <input class="input" type="text" placeholder="{{__('admin.search')}}">
                        </div>
                    </li>--}}
                </ul>
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            @can('profile')
                                <a class="dropdown-item" href="{{route('admin.users.editProfile')}}">
                                    <i class="ft-user"></i>{{__('admin.editProfile')}}
                                </a>
                            @endcan
                            ...
                            <a class="dropdown-item" href="{{ route('logout') }}"
                               onclick="event.preventDefault();
                                ...
                                <i class="ft-power"></i>{{ __('admin.logout') }}
                            </a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2">{{_('admin.messages')}}</span>
                                </h6>
