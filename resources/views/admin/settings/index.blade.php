                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">{{__('admin.settings')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <a href="{{route('admin.settings.edit',$setting->id)}}"
                                       class="btn btn-outline-warning">
                                        <i class="la la-edit"></i>{{__('admin.editSetting')}}
                                    </a>
                                        ...
                                        <div class="table-responsive">
                                            @if($setting)
                                                <table class="table table-bordered table-striped">
                                                    <tbody>
                                                    <tr>
                                                        <th scope="row">{{__('admin.siteName')}}</th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">{{__('admin.facebook_url')}}</th>
                                                        <td>{{$setting->facebook_url}}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">{{__('admin.twitter_url')}}</th>
                                                        <td>{{$setting->twitter_url}}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">{{__('admin.telegram_url')}}</th>
                                                        <td>{{$setting->telegram_url}}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">{{__('admin.favicon')}}</th>
                                                        <td>
                                                            @if($setting->favicon)
                                                                <img src="{{ url('Admin/assets/images/logo',$setting->favicon) }}"
                                                                     alt="..."
                                                                     class="img-thumbnail" width="32px" height="32px">
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">{{__('admin.logo')}}</th>
                                                        <td>
                                                            @if($setting->logo)
