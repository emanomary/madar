                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.editNew')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <form class="form" action="{{route('admin.news.update',$new->id)}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="checkbox"
                                                                   ...
                                                                   id="status"
                                                                   name="status"
                                                                   value="{{$new->status}}" {{$new->status == 1? 'checked':''}}>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            @if($new->image)
                                                                <img src="{{url('Admin/assets/images/news',$new->image)}}" alt="image"
                                                                     width="100px" height="40px" class="img-thumbnail">
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control text-right"
                                                                      name="details"
                                                                      id="details"
                                                                      cols="12" rows="15">{{$new->details }}</textarea>
                                                            @error('details')
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
