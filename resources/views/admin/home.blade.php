                                ...
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h5 class="text-muted">{{__('admin.users')}}</h5>
                                            <h3>{{$users}}</h3>
                                        </div>
                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h5 class="text-muted">{{__('admin.categories')}}</h5>
                                            <h3>{{$categories}}</h3>
                                        </div>
                                        <div class="align-self-center">
                                            <i class="icon-tag primary font-large-2 float-right"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h5 class="text-muted">{{__('admin.news')}}</h5>
                                            <h3>{{$news}}</h3>
                                        </div>
                                        <div class="align-self-center">
                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h5 class="text-muted">{{__('admin.videos')}}</h5>
                                            <h3>{{$videos}}</h3>
                                        </div>
                                        <div class="align-self-center">
                                            <i class="icon-social-youtube danger font-large-2 float-right"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h5 class="text-muted">{{__('admin.messages')}}</h5>
                                            <h3>{{$messages}}</h3>
                                        </div>
                                        <div class="align-self-center">
                                            <i class="icon-envelope secondary font-large-2 float-right"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card pull-up">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-left">
                                            <h5 class="text-muted">{{__('admin.roles')}}</h5>
                                            <h3>{{$roles}}</h3>
                                        </div>
                                        <div class="align-self-center">
                                            <i class="icon-lock default font-large-2 float-right"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate p-1">
                                                <ul class="list-unstyled users-list m-0">
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons"
                                                        class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="{{asset('assets/dashboard/images/portrait/small/avatar-s-1.png')}}"
                                                             alt="Avatar">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres"
                                                        class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="{{asset('assets/dashboard/images/portrait/small/avatar-s-2.png')}}"
                                                             alt="Avatar">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones"
                                                        class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="{{asset('assets/dashboard/images/portrait/small/avatar-s-3.png')}}"
                                                             alt="Avatar">
                                                    </li>
                                                    <li class="avatar avatar-sm">
